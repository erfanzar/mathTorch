...
def bbox_iou(box1, box2, x1y1x2y2=True, GIoU=False, DIoU=False, CIoU=False, eps=1e-7):
    ...
    if GIoU or DIoU or CIoU:
        cw = np.max(b1_x2, b2_x2) - np.min(b1_x1, b2_x1)  # convex (smallest enclosing box) width
        ch = np.max(b1_y2, b2_y2) - np.min(b1_y1, b2_y1)  # convex height
        if CIoU or DIoU:  # Distance or Complete IoU https://arxiv.org/abs/1911.08287v1
            ...
            if DIoU:
                ...
                v = (4 / math.pi ** 2) * np.power(np.arctan(w2 / (h2 + eps)) - np.arctan(w1 / (h1 + eps)), 2)
